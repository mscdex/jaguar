...
var accepts = require('accepts'),
    ...
    proxyaddrAll = require('proxy-addr').all;
...
defineGetter(Request.prototype, 'ips', function ips() {
  var addrs = proxyaddrAll(this.req, this.router.config['trust proxy fn']);
  return addrs.slice(1).reverse();
});

defineGetter(Request.prototype, 'subdomains', function _subdomains() {
